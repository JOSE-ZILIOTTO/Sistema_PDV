...
type
  Tfrmlistbox = class(TFrame)
    ...
    procedure pnlbtnexcluirClick(Sender: TObject);
  private
  ...
  public
    ...
    function item (value : integer) : Tfrmlistbox;
...
function Tfrmlistbox.item(value: integer): Tfrmlistbox;
begin
  result := self ;
  pnlitems.Caption := value.tostring;
end;
...
procedure Tfrmlistbox.pnlbtnexcluirClick(Sender: TObject);
begin
self.Free;
end;
